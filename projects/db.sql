...
DROP TABLE IF EXISTS `3tv3`.`hakuzy_mv`;
CREATE TABLE  `3tv3`.`hakuzy_mv` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=88 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='hakuzy mv';


DROP TABLE IF EXISTS `3tv3`.`guobianyu_mv`;
CREATE TABLE  `3tv3`.`guobianyu_mv` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cateen` varchar(45) DEFAULT NULL COMMENT '分类英文',
  `catecn` varchar(45) DEFAULT NULL COMMENT '分类中文',
  `url` varchar(200) DEFAULT NULL COMMENT '远程地址',
...
DROP TABLE IF EXISTS `3tv3`.`zhuzhudh_mv`;
CREATE TABLE  `3tv3`.`zhuzhudh_mv` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cateen` varchar(45) DEFAULT NULL COMMENT '分类英文',
  `catecn` varchar(45) DEFAULT NULL COMMENT '分类中文',
  `url` varchar(200) DEFAULT NULL COMMENT '远程地址',
  ...
  `pubyear` varchar(45) DEFAULT NULL COMMENT '出品年',
  `name` varchar(100) DEFAULT NULL,
  `ji` tinyint(3) unsigned DEFAULT '0' COMMENT '是否有集',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='zhuzhudh mv';


DROP TABLE IF EXISTS `3tv3`.`zhuzhutv`;
CREATE TABLE  `3tv3`.`zhuzhutv` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cateen` varchar(45) DEFAULT NULL COMMENT '分类英文',
  `catecn` varchar(45) DEFAULT NULL COMMENT '分类中文',
  `url` varchar(200) DEFAULT NULL COMMENT '远程地址',
  ...
  `ji` tinyint(3) unsigned DEFAULT '0' COMMENT '是否有集',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='zhuzhutv';
