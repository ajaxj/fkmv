...
CREATE TABLE  `ajaxj`.`mv_movie_hakuzy` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=64146 DEFAULT CHARSET=utf8 COMMENT='hakuzy';
...
CREATE TABLE  `ajaxj1`.`hakuzy` (
  ...
  `catecn` varchar(45) DEFAULT NULL COMMENT '分类中文',
  `content` text COMMENT '介绍',
  `lists` text COMMENT '地址列表',
  `img` varchar(255) DEFAULT NULL COMMENT '图片',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19135 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE  `3tv3`.`hakuzy_mv` (
  ...
  `pubyear` varchar(45) DEFAULT NULL COMMENT '出品年',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='hakuzy mv';
